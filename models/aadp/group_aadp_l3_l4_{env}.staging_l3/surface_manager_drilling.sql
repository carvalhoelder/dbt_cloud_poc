...
{{
    config(
        ...
        unique_key = ['site_name', 'source_system_name', 'reporting_date', 'asset_name', 'hole_id', 'hole_name', 'block', 'start_time_drilling', 'end_time_drilling']
    )
}}
